...
let objects = ['A plastic bottle will<br> take 40,000 years<br> to decompose if it’s<br> not recycled.',
'A plastic bottle will<br> take 40,000 years<br> to decompose if it’s<br> not recycled.',
'Recycling a single aluminium<br> can will save enough<br> electricity to power a<br> TV for three hours.',
'Recycling a single aluminium<br> can will save enough<br> electricity to power a<br> TV for three hours.',
'It only takes 25<br> recycled plastic bottles to<br> make a brand new<br> fleece jacket.',
'It only takes 25<br> recycled plastic bottles to<br> make a brand new<br> fleece jacket.',
'Around 25,000 trees<br> are cut down each<br> day just to produce<br> toilet paper.',
'Around 25,000 trees<br> are cut down each<br> day just to produce<br> toilet paper.',
'When you throw plastic<br> bags and other plastic<br> materials in the ocean<br>, it kills as many as 1 million<br> sea creatures annually.',
'When you throw plastic<br> bags and other plastic<br> materials in the ocean<br>, it kills as many as 1 million<br> sea creatures annually.',
'A programmable thermostat doesn’t<br> cost much and its<br> cost can be recovered<br> from the amount that you<br> save by reducing energy.',
'A programmable thermostat doesn’t<br> cost much and its<br> cost can be recovered<br> from the amount that you<br> save by reducing energy.',
'Unnecessary usage of electronic<br> appliances will not only<br> save fuel but also<br> increase the lifetime of your<br> gadgets.',
'Unnecessary usage of electronic<br> appliances will not only<br> save fuel but also<br> increase the lifetime of your<br> gadgets.',
'Regular maintenance will help<br> your car function properly<br> and emit less carbon<br> dioxide.',
'Regular maintenance will help<br> your car function properly<br> and emit less carbon<br> dioxide.'],
...
function init() {
    ...
    for (let i = 0; i < allCards.length; i++) {
        $deck.append($('<li class="card"><div style="width:160px;">'+ allCards[i] +'<div></li>'))
    }
    addCardListener();
